...
dirName = "images\\chips"
############################################ Create directory ###################################################

############################################ Main Window ########################################################
root=Tk()
#Title of the window
root.title("Tom's BetVoyager No ZERO (no flash) Roulette Bot GUI V2.1 made in Python")
...
def showscaptureimages(): #This is the showcap window. (Will add frames and labels etc later)
    ...
    #Title of the window
    showcap.title("Tom's BetVoyager No ZERO (no flash) Roulette Bot GUI V2.1 made in Python Image capture window display area")
    #here I put a .ico file as a picture on the window top bar.
