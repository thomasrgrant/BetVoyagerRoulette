...
dirName = "imagesBVNoZeroNoFlash-GUI-V2.3\\chips"
############################################ Create directory ###################################################

############################################ Main Window ########################################################
root=Tk()
#Title of the window
root.title("Tom's BetVoyager No ZERO (no flash) Roulette Bot GUI V2.2 made in Python")
...
lab01=Label(frame2, text='1', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=0, padx=1, pady=1)
lab02=Label(frame2, text='2', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=0, padx=1, pady=1)
lab03=Label(frame2, text='3', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=0, padx=1, pady=1)

lab04=Label(frame2, text='4', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=1, padx=1, pady=1)
lab05=Label(frame2, text='5', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=1, padx=1, pady=1)
lab06=Label(frame2, text='6', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=1, padx=1, pady=1)

lab07=Label(frame2, text='7', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=2, padx=1, pady=1)
lab08=Label(frame2, text='8', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=2, padx=1, pady=1)
lab09=Label(frame2, text='9', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=2, padx=1, pady=1)

lab10=Label(frame2, text='10', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=3, padx=1, pady=1)
lab11=Label(frame2, text='11', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=3, padx=1, pady=1)
lab12=Label(frame2, text='12', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=3, padx=1, pady=1)

lab13=Label(frame2, text='13', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=4, padx=1, pady=1)
lab14=Label(frame2, text='14', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=4, padx=1, pady=1)
lab15=Label(frame2, text='15', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=4, padx=1, pady=1)

lab16=Label(frame2, text='16', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=5, padx=1, pady=1)
lab17=Label(frame2, text='17', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=5, padx=1, pady=1)
lab18=Label(frame2, text='18', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=5, padx=1, pady=1)

lab19=Label(frame2, text='19', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=6, padx=1, pady=1)
lab20=Label(frame2, text='20', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=6, padx=1, pady=1)
lab21=Label(frame2, text='21', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=6, padx=1, pady=1)

lab22=Label(frame2, text='22', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=7, padx=1, pady=1)
lab23=Label(frame2, text='23', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=7, padx=1, pady=1)
lab24=Label(frame2, text='24', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=7, padx=1, pady=1)

lab25=Label(frame2, text='25', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=8, padx=1, pady=1)
lab26=Label(frame2, text='26', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=8, padx=1, pady=1)
lab27=Label(frame2, text='27', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=8, padx=1, pady=1)

lab28=Label(frame2, text='28', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=9, padx=1, pady=1)
lab29=Label(frame2, text='29', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=9, padx=1, pady=1)
lab30=Label(frame2, text='30', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=9, padx=1, pady=1)

lab31=Label(frame2, text='31', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=10, padx=1, pady=1)
lab32=Label(frame2, text='32', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=10, padx=1, pady=1)
lab33=Label(frame2, text='33', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=10, padx=1, pady=1)

lab34=Label(frame2, text='34', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=2,column=11, padx=1, pady=1)
lab35=Label(frame2, text='35', height=2,width=4, bg='black', fg='white', font=('Verdana', 9, 'bold')).grid(row=1,column=11, padx=1, pady=1)
lab36=Label(frame2, text='36', height=2,width=4, bg='red', fg='white', font=('Verdana', 9, 'bold')).grid(row=0,column=11, padx=1, pady=1)
...
def landednumcolorchange(newnum,bgcol,rown,coln):
    ...
    Label(frame2, text=newnum, height=2,width=4, bg=bgcol, fg='white', font=('Verdana', 9, 'bold')).grid(row=rown,column=coln, padx=1, pady=1)
####################### landed num color change ##################

####################### blanklabel_message #######################
def blanklabel_message(message):
    Label(framemessages, text=message, height=1,width=46, bg='black', fg='white', font=('Verdana', 9, 'bold')).place(x=6, y=6)
####################### blanklabel_message #######################
...
############################################ stats labels #################################################
labS01 = Label(frametall2,text=" 1", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=0,column=0, padx=1, pady=1)
labS01R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=0,column=1, padx=1, pady=1)
labS02 = Label(frametall2,text=" 2", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=1,column=0, padx=1, pady=1)
labS02R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=1,column=1, padx=1, pady=1)
labS03 = Label(frametall2,text=" 3", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=2,column=0, padx=1, pady=1)
labS03R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=2,column=1, padx=1, pady=1)
labS04 = Label(frametall2,text=" 4", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=3,column=0, padx=1, pady=1)
labS04R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=3,column=1, padx=1, pady=1)
labS05 = Label(frametall2,text=" 5", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=4,column=0, padx=1, pady=1)
labS05R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=4,column=1, padx=1, pady=1)
labS06 = Label(frametall2,text=" 6", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=5,column=0, padx=1, pady=1)
labS06R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=5,column=1, padx=1, pady=1)
labS07 = Label(frametall2,text=" 7", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=6,column=0, padx=1, pady=1)
labS07R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=6,column=1, padx=1, pady=1)
labS08 = Label(frametall2,text=" 8", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=7,column=0, padx=1, pady=1)
labS08R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=7,column=1, padx=1, pady=1)
labS09 = Label(frametall2,text=" 9", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=8,column=0, padx=1, pady=1)
labS09R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=8,column=1, padx=1, pady=1)
labS10 = Label(frametall2,text="10", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=9,column=0, padx=1, pady=1)
labS10R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=9,column=1, padx=1, pady=1)
labS11 = Label(frametall2,text="11", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=10,column=0, padx=1, pady=1)
labS11R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=10,column=1, padx=1, pady=1)
labS12 = Label(frametall2,text="12", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=11,column=0, padx=1, pady=1)
labS12R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=11,column=1, padx=1, pady=1)

labS13 = Label(frametall2,text="13", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=0,column=2, padx=1, pady=1)
labS13R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=0,column=3, padx=1, pady=1)
labS14 = Label(frametall2,text="14", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=1,column=2, padx=1, pady=1)
labS14R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=1,column=3, padx=1, pady=1)
labS15 = Label(frametall2,text="15", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=2,column=2, padx=1, pady=1)
labS15R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=2,column=3, padx=1, pady=1)
labS16 = Label(frametall2,text="16", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=3,column=2, padx=1, pady=1)
labS16R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=3,column=3, padx=1, pady=1)
labS17 = Label(frametall2,text="18", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=4,column=2, padx=1, pady=1)
labS17R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=4,column=3, padx=1, pady=1)
labS18 = Label(frametall2,text="18", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=5,column=2, padx=1, pady=1)
labS18R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=5,column=3, padx=1, pady=1)
labS19 = Label(frametall2,text="19", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=6,column=2, padx=1, pady=1)
labS19R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=6,column=3, padx=1, pady=1)
labS20 = Label(frametall2,text="20", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=7,column=2, padx=1, pady=1)
labS20R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=7,column=3, padx=1, pady=1)
labS21 = Label(frametall2,text="21", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=8,column=2, padx=1, pady=1)
labS21R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=8,column=3, padx=1, pady=1)
labS22 = Label(frametall2,text="22", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=9,column=2, padx=1, pady=1)
labS22R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=9,column=3, padx=1, pady=1)
labS23 = Label(frametall2,text="23", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=10,column=2, padx=1, pady=1)
labS23R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=10,column=3, padx=1, pady=1)
labS24 = Label(frametall2,text="24", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=11,column=2, padx=1, pady=1)
labS24R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=11,column=3, padx=1, pady=1)

labS25 = Label(frametall2,text="25", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=0,column=4, padx=1, pady=1)
labS25R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=0,column=5, padx=1, pady=1)
labS26 = Label(frametall2,text="26", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=1,column=4, padx=1, pady=1)
labS26R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=1,column=5, padx=1, pady=1)
labS27 = Label(frametall2,text="27", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=2,column=4, padx=1, pady=1)
labS27R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=2,column=5, padx=1, pady=1)
labS28 = Label(frametall2,text="28", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=3,column=4, padx=1, pady=1)
labS28R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=3,column=5, padx=1, pady=1)
labS29 = Label(frametall2,text="29", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=4,column=4, padx=1, pady=1)
labS29R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=4,column=5, padx=1, pady=1)
labS30 = Label(frametall2,text="30", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=5,column=4, padx=1, pady=1)
labS30R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=5,column=5, padx=1, pady=1)
labS31 = Label(frametall2,text="31", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=6,column=4, padx=1, pady=1)
labS31R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=6,column=5, padx=1, pady=1)
labS32 = Label(frametall2,text="32", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=7,column=4, padx=1, pady=1)
labS32R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=7,column=5, padx=1, pady=1)
labS33 = Label(frametall2,text="33", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=8,column=4, padx=1, pady=1)
labS33R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=8,column=5, padx=1, pady=1)
labS34 = Label(frametall2,text="34", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=9,column=4, padx=1, pady=1)
labS34R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=9,column=5, padx=1, pady=1)
labS35 = Label(frametall2,text="35", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=10,column=4, padx=1, pady=1)
labS35R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=10,column=5, padx=1, pady=1)
labS36 = Label(frametall2,text="36", height=1,width=2, bg='black', fg='white', font=('Verdana', 12, 'bold')).grid(row=11,column=4, padx=1, pady=1)
labS36R = Label(frametall2,text="  ", height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=11,column=5, padx=1, pady=1)
############################################ stats labels #################################################
def changelabel(num,rn,cln):
    Label(frametall2,text=num, height=1,width=3, bg='#11390F', fg='white', font=('Verdana', 12, 'bold')).grid(row=rn,column=cln, padx=1, pady=1)
############################################ labels #############################################################

############################################ listbox ############################################################
# This is the section of code which creates a listbox
listBoxOne=Listbox(frameNL, bg='black', fg='red', relief=SUNKEN, borderwidth=1, highlightthickness=0, font=('Verdana', 9, 'bold'), width=2, height=13)
...
listBoxTwo=Listbox(frameNL, bg='black', fg='white', relief=SUNKEN, borderwidth=1, highlightthickness=0, font=('Verdana', 9, 'bold'), width=2, height=13)
...
############################################ Entry ##############################################################
frameEntry = Frame(frame1, bg='#31859B', highlightbackground="black", highlightthickness=2).place(x=246, y=174, width=64, height=25)#entry border
spinamount = Entry(frame1, width=6, font=('Verdana', 10, 'bold')).place(x=248, y=176)#names
############################################ Entry ##############################################################
...
def largewin():
    ...
    butstatsB = Button(framemessages, text='StatsB', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=normalwin).place(x=537, y=4)

def normalwin():
    root.geometry('610x270+0+0')
    butstatsB = Button(framemessages, text='StatsB', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=largewin).place(x=537, y=4)

def widewin():
    root.geometry('1510x270+0+0')
    butstatsR = Button(framemessages, text='StatsR', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=widenorm).place(x=389, y=4)

def widenorm():
    root.geometry('610x270+0+0')
    butstatsR = Button(framemessages, text='StatsR', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=widewin).place(x=389, y=4)
##############@@@@@@@@@ Expand window to show stats @@@@@@@@@#####################
...
def clickchips(num):
    if num == 1:
        ...
        pyautogui.click(567, 845,)# Click the mouse. 25c chip  
    elif num == 3:
        pyautogui.click(668, 854,)# Click the mouse. $1 chip
    elif num == 4:
        pyautogui.click(770, 845,)# Click the mouse. $5 chip
    elif num == 5:
        pyautogui.click(864, 845,)# Click the mouse. $10 chip
    elif num == 6:
        pyautogui.click(963, 845,)# Click the mouse. $25 chip 
    elif num == 7:
        pyautogui.click(1061, 845,)# Click the mouse. $100 chip 
##############@@@@@@@@@ Chip positions @@@@@@@@@##################################
...
def misscount():
    if Num01 is None:
        print('Num01 missed '+str(miss))
        if str(miss) > str(maxmiss):
            changelabel(str(miss),0,1)
    else:
        str(maxmiss = miss)
        str(miss = 0) 
        changelabel(str(maxmiss),0,1)
    ...
    if Num02 is None:
        ...
        print('Number Located or did match')
        blanklabel_message('Number Located or did matchh')
...
butstatsR = Button(framemessages, text='StatsR', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=widewin).place(x=389, y=4)
butRNG = Button(framemessages, text='RNG', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=441, y=4)
#Now to make the screen caputre image GUI.
butcapimg = Button(framemessages, text='Images', width=6, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=showscaptureimages).place(x=477, y=4)
butstatsB = Button(framemessages, text='StatsB', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=largewin).place(x=537, y=4)

if os.path.isfile("images\\100D.png"):
    print ("File 100.png exist")
    Button(frame1, text='SPIN', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=yellowareaonscreen).place(x=488, y=174)
else:
    print ("File 100.png does not exist")
    Button(frame1, text='SPIN', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), state=DISABLED,command=btnClickFunction).place(x=488, y=174)

Button(frame12N, text='1st 12', height=1,width=19, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=0, y=0)
Button(frame12N, text='2nd 12', height=1,width=18, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=163, y=0)
Button(frame12N, text='3rd 12', height=1,width=19, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=319, y=0)

Button(frameEven, text='1-18', height=1,width=9, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=0, y=0)
Button(frameEven, text='EVEN', height=1,width=9, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=80, y=0)
Button(frameEven, text='RED', height=1,width=9, bg='red', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=162, y=0)
Button(frameEven, text='BLACK', height=1,width=9, bg='black', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=238, y=0)
Button(frameEven, text='ODD', height=1,width=9, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=318, y=0)
Button(frameEven, text='19-36', height=1,width=9, bg='green', fg='white', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=399, y=0)

Button(frameColumns, text='2to1', height=2,width=6, bg='green', fg='white', font=('Verdana', 8, 'bold'), command=btnClickFunction).place(x=0, y=0)
Button(frameColumns, text='2to1', height=2,width=6, bg='green', fg='white', font=('Verdana', 8, 'bold'), command=btnClickFunction).place(x=0, y=37)
Button(frameColumns, text='2to1', height=2,width=6, bg='green', fg='white', font=('Verdana', 8, 'bold'), command=btnClickFunction).place(x=0, y=73)

Button(frame1, text='AUTO', width=5, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=438, y=174)
Button(frame1, text='REBET', width=6, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=380, y=174)
Button(frame1, text='CLEAR', width=6, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=322, y=174)

Button(frame1, text='100', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=206, y=174)
Button(frame1, text='25', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=172, y=174)
Button(frame1, text='10', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=139, y=174)
Button(frame1, text=' 5 ', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=106, y=174)
Button(frame1, text=' 1 ', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=72, y=174)
Button(frame1, text='25c', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=38, y=174)
Button(frame1, text='5c', width=3, bg='#00FFFF', font=('Verdana', 9, 'bold'), command=btnClickFunction).place(x=4, y=174)
############################################ Buttons ############################################################
